...
@section('content')
<div class="span9">
	<ul class="breadcrumb" style="background-color:#0f171e; color:white;">
		<li><a href="{{ url('/')}}" style="color:white;">Home</a> <span class="divider">/</span></li>
		<li><a href="{{ url('/'.$productDetails['category']['url'])}}" style="color:white;">{{ $productDetails['category']['category_name'] }}</a> <span class="divider">/</span></li>
		<li class="active">{{ $productDetails['product_name'] }}</li>
	</ul>
	<div class="row">
		<div id="gallery" class="span3">
			<a href="{{ asset('images/product_images/'.$productDetails['main_image']) }}" title="Blue Casual T-Shirt">
				<img src="{{ asset('images/product_images/'.$productDetails['main_image']) }}" style="width:100%" alt="Blue Casual T-Shirt"/>
			</a>
			<div id="differentview" class="moreOptopm carousel slide">
				<div class="carousel-inner">
					<div class="item active">
						@foreach($productDetails['images'] as $image)
							<a href="{{ asset('images/product_images/'.$image['image']) }}"> <img style="width:29%" src="{{ asset('images/product_images/'.$image['image']) }}" alt=""/></a>
						@endforeach
					</div>
				</div>
				<!--
						...
						<div class="tab-pane" id="listView">
							...
							<div class="row">
								<div class="span2">
									...
									@else
										<img style="width: 250px;" src="{{ asset('images/product_images/no-image.png') }}" alt="">
									@endif
								</div>
								<div class="span4">
